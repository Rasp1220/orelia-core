...
public final class ApiModule implements RpgModule {
    ...
    public void onEnable(OreliaPlugin plugin) {
        ...
        servicesManager.register(JobApi.class, new JobApiImpl(jobModule.getJobService()), plugin, ServicePriority.Normal);
        ...
        servicesManager.register(SkillApi.class, new SkillApiImpl(skillModule.getProgressService()), plugin, ServicePriority.Normal);
